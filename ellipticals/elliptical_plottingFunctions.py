...
def plot_stellar_mass(gal_ID,
    ...
    ax[0].errorbar(data_table['radius'], 10**data_table['M_star'], yerr=10**(data_table['M_star_err']), 
             color='k', fmt='.')
    ...
    if stellar_profile == 'sphere':
        ...
        y = exponential_sphere(r, best_fit_values['sph_rho_c'],best_fit_values['sph_R_scale'])
        ...
        y = exponential_sphere_disk(r, best_fit_values['sphd_rho_c'],best_fit_values['sphd_R_scale'], 
                                    best_fit_values['sphd_Sigma_d'],
                                                    best_fit_values['sphd_R_d'])
        ...
        ax[0].plot(r, exponential_sphere(r, 10**best_fit_values['sphd_rho_c'], 
                                       best_fit_values['sphd_R_scale']),
                 linestyle = '--', color = 'dodgerblue', label='sphere')
        ax[0].plot(r, exponential_disk(r, 10**best_fit_values['sphd_Sigma_d'], 
                                     best_fit_values['sphd_R_d']),
        ...
        y = hernquist_profile(r, best_fit_values['hq_R_scale'], 
                                    best_fit_values['hq_M'],
                                                   )
        ...
        y = modified_hernquist_profile(r, best_fit_values['mhq_R_scale'], 
