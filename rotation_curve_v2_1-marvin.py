...
import marvin # SDSS MaNGA package for accessing data remotely
...
def extract_data( galaxy_ID):
    """
    Import the MaNGA data cube and extract data.
    ...
    galaxy_ID : string
        A string representation of the galaxy in question in the following 
        format:
                [PLATE]-[IFUID]
    ...
    Ha_vel : numpy array of shape ()
        The H-alpha velocity field data

    Ha_vel_err : numpy array of shape ()
        The error in the H-alpha velocity field data

    v_band : numpy array of shape ()
        The visual-band flux data

    v_band_err : numpy array of shape ()
        The error in the visual band flux data

    sMass_density : numpy array of shape ()
        The stellar mass density per square pixel

    manga_plate : integer
        The manga plate number of observation

    manga_fiberID : integer
        The manga fiber ID of observation
