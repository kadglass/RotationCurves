"""
Created on Thurs May 21 2020
@author: Kelly A. Douglass
@version: 2

Main script file for dark_matter_mass_v2.
"""
import datetime
...
from dark_matter_mass_v2 import fit_rot_curve, estimate_dark_matter
...
if RUN_ALL_GALAXIES:
    ...
    master_table['v_max'] = -1. * (u.km / u.s)
    master_table['r_turn'] = -1. * (u.kpc)

    master_table['v_max_sigma'] = -1. * (u.km / u.s)
    master_table['r_turn_sigma'] = -1. * (u.kpc)
    master_table['chi_square_rot'] = -1.
    master_table['chi_square_ndf'] = -1.
    ...
    #---------------------------------------------------------------------------
    master_table.write( MASTER_FILENAME[:-4] + '_v2_' + str(chi2_max) + '.txt', 
